    ...
    return (
        <div className={pageStyles.aboutPage}>
            ...
            <div className={pageStyles.textContainer}>
                ...
                <div className={styles.block}>
                    <h1 className={styles.intro}>{funFact}</h1>
                    <img src={melbourne} className={styles.introPic}></img>
                </div>
                <div className={styles.block}>
                    <h1 className={styles.intro}>{campus}</h1>
                </div>
                <div className={styles.block}>
                    <h1 className={styles.intro}>{discovery}</h1>
                </div>

                <div className={styles.block}>
                    <h1 className={styles.intro} onClick={returnHome}>Click me to return to the cards page!</h1>
                </div>
            </div>
        </div>
    );
